...
예) .venv/Scripts/python -m backtest.backfill_stock_daily --symbols 005930,000660,AAPL --days 2000
...
from backtest.toss_daily import fetch_daily, upsert_clickhouse
