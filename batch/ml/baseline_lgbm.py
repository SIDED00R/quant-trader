...
def run_market(market: str, horizon: int, seeds: int, folds: int, objective: str) -> dict:
...
def main(argv=None) -> int:
    ...
    a = p.parse_args(argv)
    rows = [run_market(mk, a.horizon, a.seeds, a.folds, a.objective) for mk in a.markets]
